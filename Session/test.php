...
session_start();
// Подключаем функцию аутентификацйии
...
if (!isset($answer) && !isset($test)){ // В ситуации если не выбран тест и не пришел вариант ответа на тест ?>
    ...
    <?php die('Обратитесь в техническую поддержку'); // Останавливаем выполнение скрипта
}
...
//            echo 'Зашли в удаление'; // Testing
            ...
            <a href="list.php">Перейти к выбору тестов</a>
            <?php die('тест ' .$test. ' был удален');
        }
